...
builder.Services.AddScoped<IClientsRepository, ClientsRepository>(); // Register IClientRepository with its implementation ClientRepository
...
//builder.Services.AddScoped<IPaginatedList<Clients>, PaginatedList<Clients>>();
builder.Services.AddScoped<IReservationsRepository, ReservationsRepository>();
builder.Services.AddScoped<IDestinationsRepository, DestinationsRepository>();
//builder.Services.AddScoped<IPaginatedList<Reservations>, PaginatedList<Reservation>>();
